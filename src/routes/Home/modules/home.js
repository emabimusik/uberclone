...
// get adress suggestion from google
...
export function getImputData(payload) {
    return {
        type: GET_INPUT,
        payload
    }
...
function handleSelectedAddress(state, action) {
...
const ACTION_HANDLERS = {
    ...
    GET_SELECTED_ADDRESS: handleSelectedAddress,
